...
Shader "SoundWaveRing"
{
	Properties
	{
		...
		_OffsetAmp1("_OffsetAmp", Float) = 0
		_RingSharp("_RingSharp", Float) = 2
		_NoiseRoundness("_NoiseRoundness", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			uniform float _OffsetAmp1;
			uniform float _RingSharp;
			uniform float _NoiseRoundness;
			uniform float _Damp;
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_15_0 = ( _Time.y * _TimeScale );
				float temp_output_17_0 = max( ( temp_output_15_0 - _ShockTime ) , 0.0 );
				...
				float2 temp_output_50_0 = ( texCoord48 - float2( 0.5,0.5 ) );
				float2 normalizeResult51 = normalize( temp_output_50_0 );
				...
				#endif
				// 基于极角采样噪声（沿圆周），并做平滑/幅度/遮罩
				float2 pDir = temp_output_50_0;                             // = (uv - 0.5)
				float theta01 = (atan2(pDir.y, pDir.x) + 3.14159265) * (1.0 / (2.0 * 3.14159265));
				float uNoise  = theta01 * max(_NoiseScale, 1e-3) + _Time.y * _NoiseSpeed;
				float2 uvNoise = float2(frac(uNoise), 0.5);
				float n = tex2Dlod(_NoiseTex, float4(uvNoise, 0, 0)).r;   // 顶点阶段要用 lod 采样
				float n1      = pow(saturate(n), max(_NoiseRoundness, 1e-4)); // 圆滑峰值（单侧外鼓）
				float dispNoise = n1 * _OffsetAmp1;                         // 噪声位移强度
				float disp = (dispNoise + 0.05 * temp_output_27_0) * temp_output_35_0; // (噪声+少量呼吸)*环形遮罩
				vertexValue = (disp * appendResult54).xyz;                  // appendResult54 = float4(dir,0,0)
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_27_0 = ( exp( -( _Damp * temp_output_17_0 ) ) * ( sin( ( ( temp_output_17_0 * 6.283185 ) * _Freq ) ) * _Amp ) );
				float temp_output_35_0 = saturate( ( 1.0 - ( abs( ( length( ( texCoord11 - float2( 0.5,0.5 ) ) ) - ( temp_output_27_0 + _Radius ) ) ) / ( _Width * 0.5 ) ) ) );
				float ring = pow( temp_output_35_0, max(_RingSharp, 1e-4) );
				float3 rgb = _LineColor.rgb * ring;
				finalColor = float4(rgb, ring);
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1748.057,-184.1233;Inherit;False;Property;_Damp;_Damp;5;0;Create;True;0;0;0;True;0;False;2;3.51;0;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-682.0341,77.41508;Inherit;False;Property;_Radius;_Radius;2;0;Create;True;0;0;0;True;0;False;0.4;0.7;0;0.7;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;65;41.61145,690.4172;Inherit;False;Polar Coordinates;-1;;1;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.BreakToComponentsNode;67;306.6115,696.4172;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleSubtractOpNode;50;-179.8774,444.1714;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;63;225.5255,1315.546;Inherit;False;Property;_RingSharp;_RingSharp;13;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;272.5255,819.5459;Inherit;False;Property;_NoiseScale;_NoiseScale;10;0;Create;True;0;0;0;True;0;False;0;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;68;473.6582,724.0543;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-23.32196,934.6059;Inherit;False;Property;_NoiseSpeed;_NoiseSpeed;11;0;Create;True;0;0;0;True;0;False;0;0.31;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;1263.049,-524.0555;Inherit;True;Property;_MainTex;_MainTex;0;1;[PerRendererData];Create;True;0;0;0;True;0;False;1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;70;727.5172,896.8601;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;69;324.8008,912.7722;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;714.5172,1046.86;Inherit;False;Constant;_Float4;Float 4;15;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;72;942.5172,931.8601;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;59;1165.526,882.5459;Inherit;True;Property;_NoiseTex;_NoiseTex;9;0;Create;True;0;0;0;True;0;False;-1;None;a7b9e63deb853425dadca5b256d0b384;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;48;-438.8771,445.1714;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;75;-179.4375,740.2327;Inherit;False;Constant;_Vector0;Vector 0;16;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;64;1194.58,1109.469;Inherit;False;Property;_NoiseRoundness;_NoiseRoundness;14;0;Create;True;0;0;0;True;0;False;0;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;74;1551.563,979.2327;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;1532.526,1118.546;Inherit;False;Property;_OffsetAmp1;_OffsetAmp;12;0;Create;False;0;0;0;True;0;False;0;0.06;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;1771.529,1020.957;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;78;2056.632,993.0748;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
WireConnection;78;1;3;0
WireConnection;78;2;76;0
ASEEND*/
//CHKSM=E5A785182CC029489E09EECDF4E837BA67B8F51E